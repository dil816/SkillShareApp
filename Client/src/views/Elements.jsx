...
import d from "../assets/clients/img/elements/d.jpg"
import f1 from "../assets/clients/img/elements/f1.jpg"
import g1 from "../assets/clients/img/elements/g1.jpg"
import g2 from "../assets/clients/img/elements/g2.jpg"
import g3 from "../assets/clients/img/elements/g3.jpg"
import g4 from "../assets/clients/img/elements/g4.jpg"
import g5 from "../assets/clients/img/elements/g5.jpg"
import g6 from "../assets/clients/img/elements/g6.jpg"
import g7 from "../assets/clients/img/elements/g7.jpg"
import g8 from "../assets/clients/img/elements/g8.jpg"
    ...
    <div>
        ...
        <section className="button-area">
          <div className="container box_1170 border-top-generic">
            ...
            <div className="button-group-area mt-40">
              <a href="#" className="genric-btn default circle arrow">Default<span className="lnr lnr-arrow-right" /></a>
              <a href="#" className="genric-btn primary circle arrow">Primary<span className="lnr lnr-arrow-right" /></a>
              <a href="#" className="genric-btn success circle arrow">Success<span className="lnr lnr-arrow-right" /></a>
              <a href="#" className="genric-btn info circle arrow">Info<span className="lnr lnr-arrow-right" /></a>
              <a href="#" className="genric-btn warning circle arrow">Warning<span className="lnr lnr-arrow-right" /></a>
              <a href="#" className="genric-btn danger circle arrow">Danger<span className="lnr lnr-arrow-right" /></a>
            </div>
            <div className="button-group-area mt-10">
              <a href="#" className="genric-btn default-border circle arrow">Default<span className="lnr lnr-arrow-right" /></a>
              <a href="#" className="genric-btn primary-border circle arrow">Primary<span className="lnr lnr-arrow-right" /></a>
              <a href="#" className="genric-btn success-border circle arrow">Success<span className="lnr lnr-arrow-right" /></a>
              <a href="#" className="genric-btn info-border circle arrow">Info<span className="lnr lnr-arrow-right" /></a>
              <a href="#" className="genric-btn warning-border circle arrow">Warning<span className="lnr lnr-arrow-right" /></a>
              <a href="#" className="genric-btn danger-border circle arrow">Danger<span className="lnr lnr-arrow-right" /></a>
            </div>
            <div className="button-group-area mt-40">
          ...
          <div className="container box_1170">
            ...
            <div className="section-top-border">
              ...
              <div className="row gallery-item">
                <div className="col-md-4">
                  <a href={g1} className="img-pop-up">
                    <div className="single-gallery-image" style={{backgroundImage: `url(${g1})`}} />
                  </a>
                </div>
                <div className="col-md-4">
                  <a href={g2}  className="img-pop-up">
                    <div className="single-gallery-image" style={{backgroundImage: `url(${g2})`}} />
                  </a>
                </div>
                <div className="col-md-4">
                  <a href={g3}  className="img-pop-up">
                    <div className="single-gallery-image" style={{backgroundImage: `url(${g3})`}} />
                  </a>
                </div>
                <div className="col-md-6">
                  <a href={g4}  className="img-pop-up">
                    <div className="single-gallery-image" style={{backgroundImage: `url(${g4})`}} />
                  </a>
                </div>
                <div className="col-md-6">
                  <a href={g5}  className="img-pop-up">
                    <div className="single-gallery-image" style={{backgroundImage: `url(${g5})`}} />
                  </a>
                </div>
                <div className="col-md-4">
                  <a href={g6}  className="img-pop-up">
                    <div className="single-gallery-image" style={{backgroundImage: `url(${g6})`}} />
                  </a>
                </div>
                <div className="col-md-4">
                  <a href={g7}  className="img-pop-up">
                    <div className="single-gallery-image" style={{backgroundImage: `url(${g7})`}} />
                  </a>
                </div>
                <div className="col-md-4">
                  <a href={g8}  className="img-pop-up">
                    <div className="single-gallery-image" style={{backgroundImage: `url(${g8})`}} />
                  </a>
                </div>
              </div>
            </div>
